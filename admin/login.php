<?php
    ...
    if(isset($_POST['admin_login_btn'])){
        ...
        if(mysqli_num_rows($res) > 0){
            ...
            $msg = "Please Enter your valid Login Details";
        }
    }
?>
                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" method="POST">
                            <div class="text-center">
                                <img src="../assets/admin/images/logo.png" alt="logo.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <input type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" value="Sign in" name="admin_login_btn">
                                        </div>
                                    </div>
