...
if (isset($_GET['type']) && $_GET['type'] != '' && isset($_GET['id']) && $_GET['id'] > 0) {
    ...
    if ($type == 'active' || $type == 'deactive') {
        ...
        $status_query = "UPDATE delivery_boy SET status='$status' WHERE id='$id'";
                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="manage_delivery_boy.php" class="category_grid">Add Delivery Boy</a>
                                        ...
                                        ?>
                                                <tr class="table">
                                                    ...
                                                    <td width="30%">
                                                        ...
                                                        <?php } ?>
                                                        <a href="manage_delivery_boy.php?id=<?php echo $row['id'] ?>"><label class="btn btn-primary">Edit</label></a>&nbsp;
                                                    </td>
                                                </tr>
                                            <?php $i++;
                                            }
